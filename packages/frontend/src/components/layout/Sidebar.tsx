  ...
  const addTag = () => {
    const newComponent = {
      ...
      data: {
        ...
        borderStyle: 'solid' as const,
        borderWidth: 1,
        shadowConfig: { enabled: false, color: '#000000', offsetX: 2, offsetY: 2, blur: 4 },
        glowConfig: { enabled: false, color: '#ff6b35', blur: 10 },
        gradientConfig: { enabled: false, colors: ['#ff6b35', '#f7c531'] as [string, string], direction: 'horizontal' as const, splitPoint: 50 },
      },
    };
    addComponent(newComponent);
  };
